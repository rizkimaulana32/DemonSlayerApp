...
class DemonsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_demons, container, false)
        rvChar = view.findViewById(R.id.rv_char2)
    ...
    private fun getListChars() : ArrayList<Character> {
        val dataName = resources.getStringArray(R.array.data_name_demon)
        val dataDesc = resources.getStringArray(R.array.data_desc_demon)
        val dataImg = resources.obtainTypedArray(R.array.data_img_demon)
